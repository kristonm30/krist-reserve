// This runs on the SERVER, never in the visitor's browser.
// Your API key stays here, read from an environment variable —
// it is never sent to or visible in the customer's browser.
